...
class VentaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request)
        {
            ...
            //Ingresos buscara en la tabla del mismo nombre
    ...
    public function store(VentaFormRequest $request)
    {
        try
        {
            DB::beginTransaction(); //Transaccion, se tienen que almacenar tanto ingreso como detalle ingreso
        ...
        {
            DB::rollback(); //Si hay error al almacenar ingreso o detalle, se anula ese almacen
        }
