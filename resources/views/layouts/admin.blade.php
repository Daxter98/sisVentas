...
<html>
  <head>
    ...
    <title>SisVentas | 2CM31 Equipo 3</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      2CM31 "Diseño de Sistemas"
                      <small>IPN-UPIICSA</small>
                      <small>Equipo 3</small>
                    </p>
                  </li>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  	<div class="row">
	                  	<div class="col-md-12">
		                          <!--Contenido-->
                                    @yield('contenido') <!--En esta seccion indicamos donde ira el contenido de nuestra pagina dentro de la plantila -->
		                          <!--Fin Contenido-->
                           </div>
                        </div>
    ...
    @stack('scripts') <!--Si se quiere agregar Jquery en cualquier vista se añade stack(nombre) y se usa el nombre en
     las-->
    <!-- Bootstrap 3.3.5 -->
